...
//[thumb]\\
let xeon = fs.readFileSync('./ThakkuduMedia/thakkudu2.0.jpg')
...
//[target]\\
	const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join PBA BoT ZoNe`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./ThakkuduMedia/thakkudu2.0.jpg`),"sourceUrl": "https://chat.whatsapp.com/D3fhKLgNybo7RP4TEKgrFc"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Subscribe PBA MODS YT Channel`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./ThakkuduMedia/thakkudu2.0.jpg`),"sourceUrl": "https://www.youtube.com/channel/UCxkxhbcHQb2B8JH3j-UVArQ"}}}, { quoted: m})
        }
try {
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/fb49a9982b80c3f0c8d34.jpg' }, caption: `*Hi bro ${m.pushName}*\n\n Bot Rental Price\n⭔ 250INR Per Group via Gpay/paytm/phonepe 1 Month\n\nFor more details, you can chat with the owner\nhttps://wa.me/50378165999 (Owner)\n\nDonate Me : \n\n⭔ Fampay : https://telegra.ph/file/fb49a9982b80c3f0c8d34.jpg\n⭔ Paytm : https://telegra.ph/file/fb49a9982b80c3f0c8d34.jpg` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply('Script : https://github.com/I4MBetAZ\n Dont Forget To Give Star\n\nYoutube : https://www.youtube.com/channel/UCxkxhbcHQb2B8JH3j-UVArQ\n Dont Forget To Subscribe')
            }
            break
            case 'chat': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https://github.com/I4MBetAZ'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Owner Number😼',
                                    phoneNumber: '+50378165999'
                                }
                            }, {
                                quickReplyButton: {
                      ...
                      fatihgans = fs.readFileSync('./ThakkuduMedia/thakkudu2.0.jpg')
	    ...
	    case 'anonymous': {
				...
				let buttons = [{
                                urlButton: {
                                    ...
                                    url: 'https://wa.me/50378165999?text=hello+bro+i+found+a+bug+in+your+bot'
                                }
                            }, {
                                quickReplyButton: {
...
RAM: ${formatp(os.totalmem() - os.freemem())} / ${formatp(os.totalmem())}
           ...
           const devsound = fs.readFileSync('./Thakkudu2.0MDMedia/creator.mp3') //u can change the music in Thakkudu2.0MDMedia folder
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https://www.youtube.com/channel/UCxkxhbcHQb2B8JH3j-UVArQ'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'Script🔖',
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            locationMessage: {
                            jpegThumbnail: fs.readFileSync('./ThakkuduMedia/thakkudu2.0.jpg')},
                            hydratedFooterText: `ʜᴇʟʟᴏ 🤠 ${pushname}
ʜᴇʟʟᴏ ɢᴀʏɪᴄʜ 👻
